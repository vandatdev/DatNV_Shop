                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                @empty(!$product->image)
                                    <img src="{{asset('uploads/products/'.$product->image)}}" alt="" width="100px">
                                @endempty
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            <input type="number" min="0" name="quantity" id="qty" class="form-control" placeholder="Quantity" value="{{$product->quantity}}">	
                                            <p class="error"></p>
                                        </div>
                                    </div>   
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="category" id="category" class="form-control">
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{$category->id}}" {{($category->id === $product_category) ? 'selected' : ''}}>{{$category->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3">
...
@section('js')
    ...
    <script>
        $('#productForm').submit(function(even){
            ...
            $.ajax({
                url: "{{route('admin.product.update', $product->slug)}}",
                type: 'PUT',
