...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{route('admin.category.create')}}" method="post" id="categoryForm" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-body">	
                        @csrf
                ...
                <div class="pb-5 pt-3">
                    <button id="submit-all" type="submit" class="btn btn-primary">Create</button>
